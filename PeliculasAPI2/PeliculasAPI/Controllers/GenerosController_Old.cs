...
namespace PeliculasAPI.Controllers
{
    ...
    public class GenerosController_Old : ControllerBase
    {
        ...
        public GenerosController_Old(ApplicationDbContext context, IMapper mapper)
        {
        ...
        [HttpGet("{id:int}", Name = "obtenerGenero_old")]
        ...
        public async Task<ActionResult> Post([FromBody] GeneroCreacionDTO generoCreacionDTO)
        {
            ...
            return new CreatedAtRouteResult("obtenerGenero_old", new { id = generoDTO.Id }, generoDTO);
        }
